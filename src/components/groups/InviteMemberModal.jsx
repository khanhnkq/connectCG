      ...
      <div className="bg-surface-main border border-border-main rounded-[2rem] w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="p-6 border-b border-border-main">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-full hover:bg-background-main text-text-secondary hover:text-text-main transition-all"
            >
              <X size={20} />
            </button>
          </div>
        ...
        <div className="p-6 border-t border-border-main bg-surface-main">
          <button
            ...
            className="w-full py-4 bg-primary text-text-main font-black rounded-xl shadow-lg hover:shadow-primary/20 active:scale-[0.98] transition-all uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            <UserPlus size={20} />
            Mời{" "}
