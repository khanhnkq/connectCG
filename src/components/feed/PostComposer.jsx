...
import { Image, Video, Globe, Users, Lock, ChevronDown } from "lucide-react";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (createdPost.status === "PENDING") {
        alert(
          "⚠️ Your post has been flagged for admin review due to potentially inappropriate content. You will be notified once it is reviewed.",
        );
      } else {
