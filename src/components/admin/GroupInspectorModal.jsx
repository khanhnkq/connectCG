                ...
                {inspectorData.activeTab === "members" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {inspectorData.members.map((member) => (
                      <div
                        key={member.userId}
                        className="bg-surface-dark p-4 rounded-2xl border border-border-dark/50 flex items-center gap-3"
                      >
                        <img
                          src={member.avatarUrl}
                          className="size-10 rounded-full bg-surface-dark border border-border-dark"
                          alt=""
                        />
                ...
                {inspectorData.activeTab === "posts" && (
                  <div className="space-y-4 max-w-3xl mx-auto">
                    {inspectorData.posts.map((post) => (
                      <div
                        key={post.id}
                        className="bg-surface-dark p-6 rounded-3xl border border-border-dark/50 space-y-4"
                      >
                          ...
                          <div className="grid grid-cols-2 gap-2 mt-2">
                            {post.images.map((img, i) => (
                              <img
                                key={i}
                                src={img}
                                className="rounded-xl w-full h-40 object-cover border border-border-dark/30"
                                alt=""
                              />
                            ))}
                          </div>
