...
const ProfileAbout = ({ profile, isOwner }) => {
  return (
    <div className="bg-surface-main rounded-2xl border border-border-main p-6 shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between text-sm py-2 border-b border-border-main">
