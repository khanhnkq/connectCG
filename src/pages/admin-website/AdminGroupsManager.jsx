      ...
      <div className="p-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-text-muted text-sm font-medium">
              Monitoring group health, ownership, and platform alignment
            </p>
          </div>
          <div className="flex gap-4">
            <div className="bg-surface-dark border border-border-dark/50 px-6 py-3 rounded-2xl flex items-center gap-3">
              <AlertTriangle className="text-orange-400 size-6" />
              <div>
                <p className="text-[10px] font-black text-text-muted uppercase leading-none">
                  Global Reports
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {groups.map((group, index) => (
            <div
              key={group.id}
              className="bg-surface-dark border border-border-dark/50 rounded-3xl overflow-hidden group hover:border-primary/30 transition-all shadow-xl"
            >
              <div className="h-44 relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  <span
                    className={`px-2.5 py-1 text-[9px] font-black uppercase rounded-lg border backdrop-blur-md ${group.privacy === "public"
