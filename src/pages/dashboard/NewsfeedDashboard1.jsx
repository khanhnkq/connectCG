  ...
  const [pendingPosts] = useState([
    {
      id: 1,
      author: "John Doe",
      content: "Is the Nikon Z9 worth it for wildlife?",
      time: "2h ago",
      image:
    ...
    },
    {
      id: 2,
      author: "Alice Smith",
      content: "Check out my latest macro shots!",
      time: "5h ago",
      image:
        "https://images.unsplash.com/photo-1452570053594-1b985d6ea82e?auto=format&fit=crop&w=800&q=80",
    },
  ]);
  ...
  const [memberRequests] = useState([
    {
      id: 101,
      name: "Lucas Vance",
      bio: "Landscape enthusiast from Seattle",
    ...
    },
    {
      id: 102,
      name: "Elena Rossi",
      bio: "Film photography is my passion",
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 flex flex-col md:flex-row md:items-end justify-between gap-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {isAdmin && (
                <button
                  onClick={() =>
                    navigate(`/dashboard/groups/edit/摄影爱好-101`)
                  }
              ...
              <div className="hidden lg:flex flex-col gap-6">
                <div className="bg-surface-main rounded-2xl p-6 border border-border-main">
                  ...
                  <p className="text-text-secondary text-sm leading-relaxed mb-4">
                    A community for photographers of all levels to share their
                    work, get feedback, and discuss gear.
                  </p>
                  <div className="flex flex-col gap-3">
                ...
                <div className="flex justify-between items-center mb-8">
                  <div>
                    ...
                    <p className="text-text-secondary text-sm font-medium mt-1">
                      Review pending content and members
                    </p>
                  </div>
              ...
              {modTab === "Posts" ? (
                <div className="flex flex-col gap-8">
                  ...
                  {pendingPosts.length === 0 && (
                    <div className="py-24 text-center space-y-4 bg-card-dark rounded-[3rem] border-2 border-dashed border-[#342418]">
                      <CheckCircle size={60} className="text-text-muted/20" />
                ...
                <div className="flex flex-col gap-4">
                  {memberRequests.map((request) => (
                    <div
                      key={request.id}
                      className="bg-card-dark border border-[#3e2b1d] p-6 rounded-3xl flex items-center justify-between hover:border-orange-500/30 transition-all group shadow-xl"
                    >
                      <div className="flex items-center gap-5">
                        <div className="relative">
                          <img
                            src={request.avatar}
                            className="size-16 rounded-2xl border-2 border-[#3e2b1d] object-cover"
                            alt=""
                          />
                  ...
                  {memberRequests.length === 0 && (
                    <div className="py-24 text-center space-y-4 bg-card-dark rounded-[3rem] border-2 border-dashed border-[#342418]">
                      <UserCheck size={60} className="text-text-muted/20" />
                      <p className="text-text-secondary font-bold uppercase tracking-widest">
